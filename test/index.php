...
$tophat->appendModule('social.items',['icon'=>'<i class="fa fa-twitter"></i>', 'url'=>'#twitter']);
$tophat->appendModule('social.items',['icon'=>'<i class="fa fa-instagram"></i>', 'url'=>'#instagram']);
