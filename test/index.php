...
$logo_src = 'https://placeholdit.co/i/200x110?bg=4b8af4&fc=fff&text=Your+logo+!';
$logoplaceholder_src = 'https://placeholdit.co/i/200x200?bg=dc5044&fc=fff&text=Logo Placeholder';
...
$tophat->setBar('topbar.logo.src',$logo_src);
//variables css personnalisées
$tophat->setBar('topbar.css.logo-max-size','240px');
...
$tophat->setBar('navigation.logo.src',$logoplaceholder_src);
$tophat->setBar('navigation.left',['navtree']);
$tophat->setBar('navigation.right',['book']);
//variables css personnalisées
$tophat->setBar('navigation.css.logo-max-size','240px');
...
$tophat->setBar('navigation3.logo.src',$logo_src);
...
$tophat->setBar('navigation2.logo.src',$logo_src);
...
$tophat->setBar('navigation4.logo.src',$logo_src);
...
$tophat->setBar('mobile.logo.src',$logo_src);
...
$tophat->setBar('mobile2.logo.src',$logo_src);
